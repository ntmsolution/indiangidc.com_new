...
/*Custom constant*/
define("ADMINFOLDERNAME","controlcenter");
define("ADMINFOLDER","controlcenter/");
define("MAX_PRODUCT_UPLOAD_FREE_USER",50);


define("PER_PAGE_REC",5);


include_once "heading-constants.php";
include_once "title-constants.php";
include_once "front-msg-constants.php";
include_once "admin-msg-constants.php";
