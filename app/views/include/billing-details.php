	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php
				...
				if($ss['gst_no_reson'] == "I am exempted")
				{
			?>
					<style>
			...
			<div class="row">
				...
				<div class="col-md-6 gnp">
					...
					<div class="form-group" style="font-size:15px;">
						<input type="radio" name="gst_no_reson" <?php echo  set_radio('gst_blank_reason', "I don't remember",($ss['gst_no_reson'] == "I don\'t remember") ? true : false); ?> value="I don't remember" class="gbr"  /> I don't remember
						&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="gst_no_reson" <?php echo  set_radio('gst_blank_reason', "I don't have it",($ss['gst_no_reson'] == "I don\'t have it") ? true : false); ?> class="gbr"  value="I don't have it" /> I don't have it
						&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="gst_no_reson" class="gbr"  <?php echo  set_radio('gst_blank_reason', 'I am exempted',($ss['gst_no_reson'] == "I am exempted") ? true : false); ?> value="I am exempted" /> I am exempted
