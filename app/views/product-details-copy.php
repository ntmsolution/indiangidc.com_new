						...
						<div class="col-md-4">
							<div class="productimg">
								<div class="owl-carousel owl-theme">
									...
									<?php 
										if($sp['product_image2'] != "")
										{
									?>
											<div class="item">
												<img src="<?php echo base_url('assets/upload/product-image/').$sp['product_image2']; ?>" height="240px" />
											</div>
									<?php
										}
										
										if($sp['product_image3'] != "")
										{
									?>
											<div class="item">
												<img src="<?php echo base_url('assets/upload/product-image/').$sp['product_image3']; ?>" height="240px" />
											</div>
									<?php
										}
										
										if($sp['product_image4'] != "")
										{
									?>
											<div class="item">
												<img src="<?php echo base_url('assets/upload/product-image/').$sp['product_image4']; ?>" height="240px" />
											</div>
									<?php
										}
										
										if($sp['product_image5'] != "")
										{
									?>
											<div class="item">
												<img src="<?php echo base_url('assets/upload/product-image/').$sp['product_image5']; ?>" height="240px" />
											</div>
									<?php
										}
									?>
