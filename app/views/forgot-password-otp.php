			...
			<div class="col-md-6 offset-md-3">
				<div class="section padd">
					<div style="padding:30px;" id="tabbody">
						<div class="form">
							<?php 
								echo form_open(FORGOT_PASSWORD_SELLER_OTP);
							?>
								...
								<div class="form-group">
									<input type="submit" name="forgot_password_otp" class="btn btn-primary" value="Verify OTP" />
									&nbsp;
...
<script>
	...
	$('.resend_otp').on('click', function(){
		$.post("<?php echo base_url("Ajax/resendSellerForgotPasswordOTP"); ?>", function(data){
