								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<select name="product_price_as_per" id="product_price_as_per" class="form-control" required >
											...
											<option value="Unit" <?php echo set_select('product_price_as_per', 'Unit',($product['product_price_as_per'] == 'Unit') ? true : false); ?> >Unit</option>
											
											<option value="Dazon" <?php echo set_select('product_price_as_per', 'Dazon',($product['product_price_as_per'] == 'Dazon') ? true : false); ?> >Dazon</option>
											
											<option value="KG" <?php echo set_select('product_price_as_per', 'KG',($product['product_price_as_per'] == 'KG') ? true : false); ?> >KG</option>
											
											<option value="Mt" <?php echo set_select('product_price_as_per', 'Mt',($product['product_price_as_per'] == 'Mt') ? true : false); ?> >Mt</option>
