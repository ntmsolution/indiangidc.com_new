...
if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	if(!function_exists('gethomepageproduct'))
	{
		function gethomepageproduct()
		{
			$ci 		= & get_instance();
			
			//$qry = "select id,seller_id,subcategory_name,category_name,product_name,product_price,product_price_as_per,product_image1,city,state,company_name,catalog_url from seller_product group by subcategory_name order by rand()";
			$qry = "select id,seller_id,subcategory_name,category_name,product_name,product_price,product_price_as_per,product_image1,city,state,company_name,catalog_url from seller_product order by rand()";
	...
	if(!function_exists('gethomesearchpageproduct'))
	{
		function gethomesearchpageproduct()
		{
			$ci 		= & get_instance();
			
			//$qry = "select id,seller_id,subcategory_name,category_name,product_name,product_price,product_price_as_per,product_image1,city,state,company_name,catalog_url from seller_product group by subcategory_name order by rand()";
			
			$catname = trim($_SESSION['product_name']);
			$productname = trim($_SESSION['product_name']);
			
			$qry = "select id,seller_id,subcategory_name,category_name,product_name,product_price,product_price_as_per,product_image1,city,state,company_name,catalog_url from seller_product where category_name like '%".$catname."%' or product_name like '%".$productname."%' order by rand()";
